...
- The pipeline (PREFLIGHT -> CONTEXT -> EXPLORE -> PLAN -> PATCH -> VALIDATE -> AST_VALIDATE -> APPLY -> VERIFY -> ROLLBACK -> SHRINK -> APPLY_BACK) is orchestration and is not expressed in the DSL.
