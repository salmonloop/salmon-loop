...
export class ArtifactStore {
  ...
  static async gc(options?: {
    ...
    // Process stats in chunks of 10 to avoid EMFILE limits while improving performance
    ...
    // First, evaluate files sequentially to build a safe removal queue
    ...
    // Finally, execute actual file deletions concurrently in chunks
