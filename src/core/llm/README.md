...
- The CLI exposes `--llm-output` to control which model outputs are shown (`review`, `assistant_message`, `explore`, `plan`, `patch`). Output is sanitized and truncated before reaching UI/CLI surfaces.
