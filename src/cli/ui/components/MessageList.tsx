...
const StreamingText = React.memo<{ content: string; maxLines: number }>(({ content, maxLines }) => {
            ...
            <Box marginTop={1} marginBottom={0} paddingLeft={2}>
              {isStreaming ? (
                <Box flexDirection="column">
                  <StreamingText content={msg.content} maxLines={streamingMaxLines} />
                  <StreamingCursor />
                </Box>
              ) : (
                <Markdown theme={markdownTheme} mode={markdownRenderMode}>
      ...
      <Static items={completedMessages}>
        {(msg, index) => (
          <MessageItem
            ...
            streamingMaxLines={streamingMaxLines}
          />
        )}
      </Static>
